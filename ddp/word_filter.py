...
def word_filter_counter(text, filter_words):
    ...
    # Remove punctuation from the text and convert it to lower case
...
# Example Test Cases
print(word_filter_counter("Hello world, hello!", ["hello"]))  # {"hello": 2}
print(word_filter_counter("The quick brown fox.", ["the"]))  # {"the": 1}
print(word_filter_counter("Is this real life? Is this just fantasy?", ["is", "this", "just"]))  # {"is": 2, "this": 2, "just": 1}
print(word_filter_counter("Do we see the big picture or just small details?", ["we", "the", "or"]))  # {"we": 1, "the": 1, "or": 1}
